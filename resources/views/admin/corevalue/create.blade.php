                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('corevalue.store') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label>Title <span class="text-danger">*</span></label>
                                            <input class="form-control" name="title" placeholder="Integrity" required />

                                        </div>

                                        <div class="form-group">
                                            <label>Icon Class <span class="text-danger">*</span></label>
                                            <input class="form-control" name="icon" placeholder="fas fa-gem" required />
