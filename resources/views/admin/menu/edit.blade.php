...
@section('content')
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
                                             ...
                                             <div class="col-sm-11">
                                                <select name="root_id" class="form-control"   onchange="ajaxSearch(this.value,'subcatid','root_id')">
                                                    ...
                                                    @foreach($main as $main_menu)
                                                        <option value="{{$main_menu->id}}" {{ $menu->root_id == $main_menu->id ? 'selected' : '' }}>{{$main_menu->menu_name}}</option>
                                                    @endforeach
           ...
           <!--                                     <div id="subcatid">-->
           <!--                                     <select name="sroot_id" class="form-control" onchange="ajaxSearch(this.value,'lastcatid','sroot_id')">-->

           <!--                                         <option value="">Select Sub Menu</option>-->

           <!--                                         @foreach($sub_main as $sub_menu)-->
           <!--                                             <option value="{{$sub_menu->id}}" {{ $menu->sroot_id == $sub_menu->id ? 'selected' : '' }}>{{$sub_menu->menu_name}}</option>-->
           <!--                                         @endforeach-->
           ...
           <!--                                         <option value="{{$sroot_menu->id}}" {{ $menu->troot_id == $sroot_menu->id ? 'selected' : '' }}>{{$sroot_menu->menu_name}}</option>-->
           <!--                                     @endforeach-->
