                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('partner.update', $partner->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="website" value="{{ $partner->website }}" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($partner->image)
                                                <img src="{{ asset('uploads/partners/'.$partner->image) }}" class="img-thumbnail" width="150" />
                                            @endif
                                        </div>

                                        <div class="form-group">
                                            <label>Display Order</label>
                                            <input class="form-control" name="order" type="number" value="{{ $partner->order }}" />
                                        </div>
