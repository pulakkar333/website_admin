    ...
    public function store(Request $request)
{
    $this->validate($request, [
        'title' => 'required',
        'file' => 'required|mimes:jpeg,jpg,png,bmp,pdf,doc,docx|max:10240', // max 10MB
    ]);
    ...
    if ($file) {
        ...
        $uploadPath = 'uploads/publication';
    ...
    $publication->image = $filename; // store all file types here
